							...
							<form action="matakuliah_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input name="Kode_Matakuliah" type="text" class="form-control" placeholder="Kode MataPelajaran" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input name="Nama_Matakuliah" type="text" class="form-control" placeholder="MataPelajaran" />
									</div>
								</div>
								<!-- <div class="form-group">
								<label>SKS</label>
