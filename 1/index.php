...
<body class="hold-transition skin-blue sidebar-mini im">
  <div class="wrapper">
    <?php
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                ...
                <center><img src="../aset/foto/bgLogin.JPG" width="50%" height="50%" /></center>
                <center>
                  <h2><b>
                      <p style="text-transform:capitalize;">Hi <?php echo "" . $_SESSION["Username"] . "" ?>, </p>
                      <p>Selamat Datang di Raudlatul Musthofa</p>
                    </b></h2>
                </center>
