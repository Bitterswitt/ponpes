    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="about.php"><i class="fa fa-info-circle"></i><span>Tentang Raudlatul Musthofa</span></a></li>
        </ul>
      </section>
      <!-- /.sidebar -->
    </aside>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                ...
                <center><img src="../aset/foto/WD.jpg" width="298" height="298" /></center>
                <center>
                  <h2><b>
                      <p style="text-transform:capitalize;">Hi <?php echo "" . $_SESSION["Username"] . "" ?>, </p>
                      <p>Welcome To Ruang Siswa</p>
                    </b></h2>
                </center>
